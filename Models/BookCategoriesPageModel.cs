...
namespace Alb_Ovidiu_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Alb_Ovidiu_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Alb_Ovidiu_Lab8Context context,
